...
module.exports = {
  en: {
    about: {
      ...
      tldr:
        "<h2>TL;DR</h2><p>I am Thomas Prost, a full stack web engineer born in France who worked in Tokyo, San Francisco and London. I have been enjoying creating websites for about 10 years, you can find some of my <a href='https://github.com/thomasprost' target='_blank' rel='noopener noreferrer'>work here</a>. I have been lucky enough to live and work in many awesome places and adapt to different working environments. I always focus on helping companies delivering great quality websites with a user first vision. You can contact me in English, French or Japanese through the <a href='/contact'>contact form</a> or directly on <a href='https://www.linkedin.com/in/thomas-prost-2bbbb427' target='_blank'>LinkedIn</a>.</p>",
      indepth:
  ...
  fr: {
    ...
    contact: {
      ...
      tldr:
        "<h2>TL;DR</h2><p>Je m'appelle Thomas Prost, je suis développeur full-stack. J'ai travaillé longtemps à l'étranger, notamment à Tokyo, San Francisco et Londres. Je suis maintenant de retour en France sur Lyon. Cela fait plus de 10 ans que je prends du plaisir à créer des sites. Vous pouvez trouver certains de mes projets professionnels et personnels <a href='https://github.com/thomasprost' target='_blank' rel='noopener noreferrer'>sur mon github</a> ainsi que, sur ce site, des articles traitant de développement web et de cuisine nipponne. Je m'évertue à créer des sites de qualité, facile à maintenir pour ses administrateurs et agréables pour ses utilisateurs. Vous pouvez me contacter en Français, Anglais ou Japonais depuis le formulaire ci-dessous ou sur <a href='https://www.linkedin.com/in/thomas-prost-2bbbb427' target='_blank'>LinkedIn</a>.</p>",
      history:
